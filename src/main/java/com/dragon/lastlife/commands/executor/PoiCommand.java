                ...
                .then(literal("add")
                        ...
                        .then(argument("id", StringArgumentType.string())
                                .executes(context -> {
                                    ...
                                    ConfigLocation location = new ConfigLocation(id, player.getLocation());
                                ...
                                .then(argument("blockPos", ArgumentTypes.blockPosition())
                                        .executes(context -> {
                                            ...
                                            Utils.configs().POI_CONFIG().pois.put(new ConfigLocation(id, blockPos.x(), blockPos.y(), blockPos.z(), 0f, 0f, player.getWorld().getName()));
                                            Utils.configs().POI_CONFIG().save();
                                            player.sendMessage(Utils.configs().MESSAGE_CONFIG.get("cmd.poi.add", id));
                                            return 1;
                                        }))))
